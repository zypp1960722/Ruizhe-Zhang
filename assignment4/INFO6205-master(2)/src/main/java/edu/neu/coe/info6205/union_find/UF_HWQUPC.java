...
public class UF_HWQUPC implements UF {
   ...
   /* public int find(int p) {
    ...
    public static int count(int n) {
    	int i=0;
    	UF_HWQUPC unionA=new UF_HWQUPC(n);
    	//UF_HWQUPC findA=new UF_HWQUPC(n);
    	//unionA.union(n, n);
    	while(unionA.components()>1) 
    		 {
			...
			int max=n;
    		 ...
    		 if(unionA.find(a)!=unionA.find(b))unionA.union(a, b);
    		 i++;
    ...
    public static void main(String[] args) {
    	...
    	//time.resume();
    	System.out.println("n= "+n+". m="+res+". runningtime = "+t1);
    }
